corpus = [["The child liked the chocolate","She was stopped by the bravest knight.","Mary baked a cake for his birthday","She decorated the cake carefully","Mary wore a dress with polka dots"],
...
function droplang(){
	...
	if(s == 'english'){
		document.getElementById("dropdown2").innerHTML = "<select id='englishdrop' ><option value='select2'>---Select a sentence--- </option><option value='sen1'>The child liked the chocolate. </option><option value='sen2'>She was stopped by the bravest knight. </option><option value='sen3'>Mary baked a cake for his birthday.</option><option value='sen4'>She decorated the cake carefully.</option><option value='sen5'>Mary wore a dress with polka dots.</option></select>";
	}
	if(s == 'hindi'){
		document.getElementById("dropdown2").innerHTML = "<select id='hindidrop'><option value='select3'>---Select a sentence--- </option><option value='hin1'>राम ने सीता के लिए फल तोड़ा।</option><option value='hin2'>छोटे बच्चे पाठशाला जल्दी आयेंगे।</option><option value='hin3'>मेहनत का फल मीठा होता है।</option><option value='hin4'>वाह! वह खूबसूरत है।</option><option value='hin5'>पेड़ से पत्ते गिर गए।</option></select>";
	}
}
function experiment(){
	document.getElementById("image").style.display = "none";
